...
<!-- Fixed navbar -->
      ...
      <div class="navbar-header">
                ...
                <img src="resources/images/hospital-logo.jpg" alt="logo" class="img img-responsive"  width="80" height="80"/></a>
                </div>
        ...
        <li class="dropdown">
          ...
          <span class="glyphicon glyphicon-header"><font color="white">SuperAdmin</font></span><span class="caret"></span></a>
          <ul class="dropdown-menu">
